...
echo ""
echo "     npm does not support subdirectory git installs. Clone the repo"
echo "     and install the adapter from the local path:"
echo ""
echo "       git clone https://github.com/bkrabach/amplifier-paperclip-adapter.git"
echo "       cd your-paperclip-project"
echo "       npm install /path/to/amplifier-paperclip-adapter/adapter"
echo ""
